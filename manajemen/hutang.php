...
<head>
    ...
    <title>Catatan Hutang - KasFlow</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar">
            ...
            <a href="hutang.php" class="active"><i class="fa fa-list me-2"></i> Catatan Hutang</a>
        ...
        <main class="col-md-10 ms-sm-auto content">
            <div class="table-container mb-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="mb-0">Catatan Hutang</h4>
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class="fa fa-plus"></i> Tambah Hutang</button>
                </div>
                ...
                <table id="tabelHutang" class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                        $query = mysqli_query($koneksi, "SELECT * FROM hutang ORDER BY id DESC");
                        while($data = mysqli_fetch_assoc($query)):
                            ...
                            <td>
                                ...
                                <a href="hutang_aksi.php?hapus=<?= $data['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')" title="Hapus"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                        <!-- Modal Edit -->
                        <div class="modal fade" id="modalEdit<?= $data['id'] ?>" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="hutang_aksi.php" method="POST">
