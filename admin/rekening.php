...
<div class="container-fluid">
    <div class="row">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar">
            ...
            <a href="rekening.php" class="active"><i class="fa fa-wallet me-2"></i> Rekening</a>
        ...
        <main class="col-md-10 ms-sm-auto content">
            <div class="table-container mb-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="mb-0">Rekening Bank</h4>
                    <button class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class="fa fa-plus"></i> Tambah Rekening</button>
                </div>
                ...
                <div class="table-responsive">
                    <table id="tabelRekening" class="table table-striped">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $query = mysqli_query($koneksi, "SELECT * FROM rekening ORDER BY id DESC");
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="rekening_aksi.php?hapus=<?= $data['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')" title="Hapus"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <!-- Modal Edit -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="rekening_aksi.php" method="POST">
                                            <div class="modal-body">
                                                <input type="hidden" name="rekening_id" value="<?= $data['id'] ?>">
                                                <div class="mb-3">
                                                    <label class="form-label">Nama Rekening</label>
                                                    <input type="text" class="form-control" name="rekening_nama" value="<?= htmlspecialchars($data['nama']) ?>" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Nomor</label>
                                                    <input type="text" class="form-control" name="rekening_nomor" value="<?= htmlspecialchars($data['nomor']) ?>" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Saldo</label>
                                                    <input type="number" class="form-control" name="rekening_saldo" value="<?= $data['saldo'] ?>" required>
                                                </div>
                                            </div>
