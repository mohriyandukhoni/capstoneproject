...
<div class="container-fluid">
    <div class="row">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar">
            ...
            <a href="kategori.php" class="active"><i class="fa fa-tags me-2"></i> Kategori</a>
        ...
        <main class="col-md-10 ms-sm-auto content">
            <div class="table-container mb-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class="fa fa-plus"></i> Tambah Kategori</button>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="kategori_aksi.php?hapus=<?= $data['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')" title="Hapus"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        <!-- Modal Edit -->
                                    ...
                                    <form action="kategori_aksi.php" method="POST">
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="kategori_nama" value="<?= htmlspecialchars($data['nama']) ?>" required>
                                            </div>
                                            <div class="mb-3">
