    ...
    <div class="row">
        ...
        <div class="offcanvas offcanvas-start d-md-none" tabindex="-1" id="sidebarOffcanvas" aria-labelledby="sidebarOffcanvasLabel">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="sidebarOffcanvasLabel">Manajemen Keuangan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div class="offcanvas-body p-0">
                <!-- Sidebar content -->
                <div class="sidebar-header mb-4">Manajemen Keuangan</div>
                ...
                <a href="kategori.php"><i class="fa fa-folder me-2"></i> Data Kategori</a>
                ...
                <a href="rekening.php"><i class="fa fa-building-columns me-2"></i> Rekening Bank</a>
                <a href="pengguna.php"><i class="fa fa-users me-2"></i> Data Pengguna</a>
